# Assignment 8 by Mimi Trinh
# Using starter code from Canvas and help from 422 Slack channel
...
# using glove.6B.50d.txt and 10,000 EVOCABSIZE, average accuracy of test set is 0.6258
...
with tf.Session() as sess:
    ...
    for epoch in range(n_epochs):
        ...
        acc_test = accuracy.eval(feed_dict={X: X_test, y: y_test})
        print('\n  Test accuracy:', acc_test)
# using glove.6B.100d.txt and 10,000 EVOCABSIZE, average accuracy of test set is 0.6378
...
EVOCABSIZE = 15000  # specify desired size of pre-defined embedding vocabulary 
...
with tf.Session() as sess:
    ...
    for epoch in range(n_epochs):
        ...
        acc_test = accuracy.eval(feed_dict={X: X_test, y: y_test})
        print('\n  Test accuracy:', acc_test)
# using glove.6B.50d.txt and 15,000 EVOCABSIZE, average accuracy of test set is 0.6307
...
with tf.Session() as sess:
    ...
    for epoch in range(n_epochs):
        ...
        acc_test = accuracy.eval(feed_dict={X: X_test, y: y_test})
        print('\n  Test accuracy:', acc_test)
# using glove.6B.100d.txt and 15,000 EVOCABSIZE, average accuracy of test set is 0.6148

# using glove.6B.50d.txt and 10,000 EVOCABSIZE, average accuracy of test set is 0.6258
# using glove.6B.100d.txt and 10,000 EVOCABSIZE, average accuracy of test set is 0.6378
# using glove.6B.50d.txt and 15,000 EVOCABSIZE, average accuracy of test set is 0.6307
# using glove.6B.100d.txt and 15,000 EVOCABSIZE, average accuracy of test set is 0.6148
# from the result above, best model uses glove.6B.100d.txt and 10,000 EVOCABSIZE
